    ...
    <div className="container">
      <div className="py-5 text-center mx-5 px-5">
        <h2 className="advantage_h2">
          Endlich ein neues Darmgefühl, damit Dich nichts mehr
          aufhält!
        </h2>
      ...
      <div className="grid_div">
        <div className="content-box">
          ...
          <div>
            ...
            <p className="adv_p">
              Der einzigartige Komplex aus essenziellen Nährstoffen fördert die
              Entgiftung deines Körpers, indem es den Darm ganzheitlich reinigt
              und exogene und endogene Toxine absorbiert, die das
        ...
        <div className="content-box">
          ...
          <div>
            ...
            <p className="adv_p">
              Colonpax kann deine Energie steigern und bring die Darmfunktion in
              Schwung. Es löst die Verstofung, reduziert den Blähbauch und
