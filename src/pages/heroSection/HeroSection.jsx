                        ...
                        <div className='container'>
                                <div className="row overflow-hidden" >
                                        <div className="col-md-7 hero_div">
                                                <h2 className='common_h2'>Verbessere deine <br /> Darmgesundheit - <br /> Optimiere dein <br /> Körpergewicht</h2>
                                                <p className='common_p'>Colonpax ist ein sicherer und effektiver Weg, wie du Verstopfungen auf eine natürliche Weise lösen, Gewicht reduzieren und auch Blähungen vermindern kannst. Beantworte das kostenfreie Quiz und erfahre, wie es dir helfen kann.</p>
